        ...
        <div class="mt-5">
            ...
            <div class="detail">
                <div class="form">
                    ...
                    @endif 
                 <form  action="{{ url('admin/storeteam')}}" enctype="multipart/form-data" method="POST" >
                         @csrf
                        <div class="part">
                         ...
                         <div class="part">
                          ...
                          <div class="part">
                            ...
                            <div class="col-md-12 data">
                                <input type="text" placeholder="Enter Qualification" name="qualification" value="" >
                            </div>   
                        </div>  
                        ...
                        <a href="{{url('admin/teamview')}}">Back to Home?</a>       
                    </div>
