...
<body class="body"> 
    ...
    <div class="page my-4 title1">
        <div class="mt-5">
            <h4 class="mb-4">ADD NEW WORK STEP</h4>
           ...
           @endif
            ...
            <div class="detail">
                <div class="form">
                    ...
                    @endif 
                 <form  action="{{url('admin/storewrokstep')}}" enctype="multipart/form-data" method="POST" >
                         @csrf
                            <div class="part">
                            ...
                            <div class="col-md-12">
                                  <input type="file" value="" name="image" accept="image/*"  onchange="readURL(this);" required />
                                  <img id="blah" src="#" alt="" />
                         ...
                         <div class="part">
                            ...
                            <div class="col-md-12 data">
                                <input type="number" placeholder="Enter step number" name="step_number" value=""required>
                            </div>   
                        </div>                           
                        ...
                        <div class="main-button">
                            ...
                            <a href="{{url('admin/wroksteplist')}}"> Back to Home?</a>
