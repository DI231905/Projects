                         ...
                         <div class="part part1">
                            <div class="col-md-12 label">
                             ...
                             <div class="col-md-12 data" style="display:flex; margin-top: 10px; ">
                                <button style="color:white; background-color:#242e42;">Short Description{{$key+1}}</button>
                                <input type="text" placeholder="" name="short_description" value="{{$m->more_maintitle}}" readonly>
 ...
 <script type="text/javascript">
         function readURL(input) {
          ...
          $("#addRow").click(function () {
            ...
            html += '<div class="days">';
            html += ' <input type="text" placeholder="Enter main title" name="short_descriptions[]" value="" >';
