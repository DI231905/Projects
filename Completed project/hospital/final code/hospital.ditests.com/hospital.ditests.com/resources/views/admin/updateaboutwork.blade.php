...
<body class="body"> 
        ...
        <div class="mt-5">
            ...
            <div class="detail">
                <div class="form">
                    ...
                    @endif 
                 <form  method="POST"  action="{{ url('admin/storeaboutwork')}}/{{$id}}" enctype="multipart/form-data">
                         @csrf
                        <div class="part">
                         ...
                         <div class="part">
                           ...
                           @foreach($about_workimage as $ai)
                            ...
                            <div class="desc"><button  class="btnsubmit" onclick="deleteworkimage({{$ai->id}})">Delete Image</button>
                           </div>
                           </div>  
    ...
    <script type="text/javascript">
          ...
          function deleteworkimage($id){

    if(confirm("do you want delete this record ?")){
             $.ajax({

                url:'deleteworkimage/'+$id,
                type:'GET',
                dataType: "json",
