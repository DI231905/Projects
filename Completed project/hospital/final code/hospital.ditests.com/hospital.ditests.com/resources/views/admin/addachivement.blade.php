...
<body class="body"> 
    ...
    <div class="page my-4 title1">
        <div class="mt-5">
            <h4 class="mb-4">ADD ACHIVEMENT IMAGE </h4>
            <div class="detail">
                <div class="form">
                    ...
                    @endif 
                 <form  method="POST"  action="{{ url('admin/storeachivement')}}" enctype="multipart/form-data">
                         @csrf
                        <div class="part">
                        ...
                        <div class="main-button">
                            ...
                            <a href="{{url('admin/achivementlist')}}"> Back to Home?</a>     
                        </div>
                    </form>        
                </div>
