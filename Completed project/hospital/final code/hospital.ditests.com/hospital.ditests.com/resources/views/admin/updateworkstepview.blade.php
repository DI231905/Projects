...
<body class="body"> 
    ...
    <div class="page my-4 title1">
        <div class="mt-5">
            <h4 class="mb-4"> UPDATE WORK STEP</h4>
           ...
           @endif
            ...
            <div class="detail">
                <div class="form">
                    ...
                    @endif 
                 <form  action="{{url('admin/storeupdatewrokstep')}}/{{$id}}" enctype="multipart/form-data" method="POST" >
                         @csrf
                             <div class="part">
                         ...
                         <div class="part">
                            ...
                            <div class="col-md-12 data">
                                <input type="number" placeholder="Enter step number" name="step_number" value="{{$step_no}}"required>
                            </div>   
                        </div>                           
