            ...
            <div class="detail">
              ...
              @if ($errors->any())
                ...
                <div class="form">
                 ...
                 <form  action="{{url('admin/storehomeaboutus')}}/{{$id}}" enctype="multipart/form-data" method="POST" >
                         @csrf
                      <div class="part">
                          ...
                          <div class="part">
                            <div class="col-md-12 label">
                                <label>signatureImage</label>
                            </div>
                            <div class="col-md-12">
                                 <input type="file" value="{{$sign_image}}" name="sign_image" accept="image/*"   />
                                <!--  <img id="output" src="/uploads/{{$sign_image}}" width="120" height="120" /> -->
                                  <input type="hidden" name="oldimage1" value="{{$sign_image}} "/>
                             </div>   
                        </div>
                    ...
                    <div class="part">
                            ...
                            <div class="col-md-12 data">
                                <input type="text" placeholder="Enter Image Title Name" name="imagetitle" value="{{$imagetitle}}">
                            </div>   
                        </div>       
                         ...
                         <div class="part">
                            ...
                            <div class="col-md-12 data">
                                <input type="text" placeholder="Enter Designation" name="Designation" value="{{$Designation}}">
                            </div>   
                        </div>       
                      ...
                      <a href="{{url('admin/Homeaboutuslist')}}"> Back to Home?</a>
