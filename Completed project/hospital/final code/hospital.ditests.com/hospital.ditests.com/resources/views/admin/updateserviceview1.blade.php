            ...
            <div class="detail">
              ...
              @if ($errors->any())
                ...
                <div class="form">
                 ...
                 <form  action="{{url('admin/storeupdateservice1')}}/{{$id}}" enctype="multipart/form-data" method="POST" >
                         @csrf
                        ...
                        <div class="part">
                            ...
                            <div class="col-md-12">
                                  <input type="file" value="{{$image1}}" name="image1" accept="image/*"  onchange="readURL(this);" />
                                  <img id="blah" src="/uploads/{{$image1}}" width="120" height="120" />
