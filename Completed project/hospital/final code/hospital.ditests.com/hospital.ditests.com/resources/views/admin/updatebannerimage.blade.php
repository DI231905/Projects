            ...
            <div class="detail">
              ...
              @if ($errors->any())
                ...
                <div class="form">
                 ...
                 <form  action="{{url('admin/storeupdatebannerimg')}}/{{$id}}" enctype="multipart/form-data" method="POST" >
                         @csrf
                      <div class="part">
                            ...
                            <div class="col-md-12 data">
                                <input type="text" placeholder="Enter Page Name" name="page" value="{{$page_name}}"required>
                            </div>   
                        </div>   
                        </div>
                        ...
                        <div class="main-button">
                            ...
                            @if($name=="About Us")
                              <a href="{{url('admin/aboutusBannerlist')}}"> Back to Home?</a>
                             @elseif($name=="Doctors")
                              <a href="{{url('admin/doctorbanner')}}"> Back to Home?</a> 
                             @elseif($name=="Gallery")
                              <a href="{{url('admin/gallarybanner')}}"> Back to Home?</a> 
                             @elseif($name=="Hospital Service")
                             <a href="{{url('admin/hospital_service')}}"> Back to Home?</a> 
                             @elseif($name=="Diagnostic Services")
                              <a href="{{url('admin/diagnostic_service')}}"> Back to Home?</a>
                              @elseif($name=="Contact Us")
                              <a href="{{url('admin/contactusbanner')}}"> Back to Home?</a>
                              @else
