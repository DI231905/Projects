...
/*
     ...
     public function deleteservice($id){
         ...
         if ($services[0]->image!='') {
            ...
            unlink("/home/mzldwoswysm5/public_html/rrtransportation.ditests.com/uploads/".$services[0]->image);
            }
/*            if ($services[0]->service_image!='') {

            unlink(public_path("/uploads/".$services[0]->service_image));
          ...
          $imagename=time().'_'.$file->getClientOriginalName();
           ...
           DB::table('service')->where('id', $id)->update(['image'=>$imagename]);
            ...
            if ($request->input('oldimage')!='') {
              ...
              unlink("/home/mzldwoswysm5/public_html/rrtransportation.ditests.com/uploads/".$request->input('oldimage'));
             }
    ...
    public function store_we_are_hiring(Request $request,$id)
    {
      ...
      if($image)
      {
        ...
        if ($request->input('oldimage')!='') 
        {
          ...
          unlink("/home/mzldwoswysm5/public_html/rrtransportation.ditests.com/uploads/".$oldimage);
