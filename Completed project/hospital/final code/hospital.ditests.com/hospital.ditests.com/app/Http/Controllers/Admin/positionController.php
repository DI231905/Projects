...
class positionController extends Controller
{
    ...
    public function storeposition(Request $request){
        ...
        $vacancy_type=$request->input('vacancy_type');
         ...
         DB::table('position')->insert(['name'=>$name,'no_of_vacancy'=>$no_of_vacancy,'vacancy_type'=> $vacancy_type]);
   ...
   public function storeupdateposition(Request $request,$id){
     ...
     $request->validate([
        ...
        $vacancy_type=$request->input('vacancy_type');
          ...
          DB::table('position')->where('id', $id)->update(['name'=>$name,'no_of_vacancy'=>$no_of_vacancy,'vacancy_type'=> $vacancy_type]);
