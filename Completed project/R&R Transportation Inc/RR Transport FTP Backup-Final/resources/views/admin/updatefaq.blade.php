            ...
            <div class="detail">
              ...
              @if ($errors->any())
                ...
                <div class="form">
                 ...
                 <form  action="{{url('admin/storeupdatefaq')}}/{{$id}}" enctype="multipart/form-data" method="POST" >
                         @csrf
                          ...
                          <div class="part">
                            ...
                            <div class="col-md-12 data">
                                <input type="text" placeholder="Enter Question" name="question" value="{{$question}}"required>
                            </div>   
                        </div> 
                        ...
                        <div class="part">
                            ...
                            <div class="col-md-12 data">
                                 <textarea placeholder="Enter text.."  name="answer" value="{{$answer}}" id="summernote" required>{!! $answer !!}</textarea>
                            </div>   
                        </div> 
