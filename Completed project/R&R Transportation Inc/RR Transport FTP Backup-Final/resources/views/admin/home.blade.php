                        ...
                        <table class="table table-bordered table-striped">
                          ...
                          @foreach($position as $key =>$p)
                             <tbody class="position_{{$p->id}}">
                                 ...
                                 <tr>
                                  <td><b>Application NO :</b> </t> {{$key+1}} </td>
                                </tr>

                                <tr>
                                  <td><b>Post Name  :</b> </t> {{$p->name}} </td>
                                </tr>

                                <tr>
                                  <td><b>NO of Vacancy  :</b> </t> {{$p->no_of_vacancy}} </td>
                                </tr> 
                                       
                                <tr>                                   
                                  <td><b>Type of Vacancy  :</b> </t>@if($p->vacancy_type==1)
                                                                            CONTRACT 
                                                                      @elseif($p->vacancy_type==2) 
                                                                         FULL TIME
                                                                      @elseif($p->vacancy_type==3) 
                                   ...
                                   <tr>                             
                                      <td><b>Country Name  :</b> </t> {{$p->country}} </td>
                                   </tr>
                                   <tr>
                                      <td><b>Responsibilities  :</b> </t> {{$p->Responsibilities}} </td>
                                   </tr>
                                    <tr>
                                      <td><b>Requirements  :</b> </t> {!! $p->Requirements !!} </td>
                                   </tr>
