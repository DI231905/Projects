...
<body class="body">       
    ...
    <div class="page my-4 title1">
        <div class="mt-5">
            <h4 class="mb-4">UPDATE INQUIRY CONTENTS</h4>
            <div class="detail">
              ...
              @if ($errors->any())
                ...
                <div class="form">
                 ...
                 <form  action="{{url('admin/storeinquirycontent')}}/{{$id}}" enctype="multipart/form-data" method="POST" >
                         @csrf
                        ...
                        <div class="part">
                            ...
                            <div class="col-md-12 data">
                                <input type="text" placeholder="Enter subtitle Name" name="subtitle" value="{{$subtitle}}">
                            </div>   
                        </div> 
