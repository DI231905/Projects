...
<!--     <input type="text" class="close" data-dismiss="alert"></input> -->
	    ...
	    <form method="POST" action="{{url('admin/updatepassword')}}/{{Auth::id()}}" class="form1">
		    ...
		    <div class="email">
		    	...
		    	<div class="text">
		    		 <input type="password" placeholder="Enter your old password" name="oldpassword" value="" required autocomplete="off">
		    	</div>  
		    </div>
		    <div class="email">
		    	<div class="icon">
		    	...
		    	<div class="text">
		    		 <input type="password" placeholder="Enter your new password" id="passsword" name="newpassword" value="" required autocomplete="off">
