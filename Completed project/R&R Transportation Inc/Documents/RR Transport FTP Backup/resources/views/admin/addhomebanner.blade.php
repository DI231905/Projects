                 ...
                 <form  action="{{url('admin/storehomebanner')}}" enctype="multipart/form-data" method="POST" >
                        ...
                        <div class="part">
                           ...
                           <div class="part">
                            ...
                            <div class="col-md-12 data">
                                <input type="text" placeholder="Enter Title" name="title" value="" autocomplete="off">
                            </div>   
                        </div>
                        ...
                        <div class="part">
                          ...
                          <div class="col-md-12 data data1">
                             <div class=" data1">
                                <input  type="text" placeholder="Enter main title" name="maintitle" value="" autocomplete="off" >
