...
<body>
	...
	<div class="form">
		   ...
		   <ul>
		   	@if($Trailer_type==1)
		   	<li><b>Trailer type:</b>  Dry Van </li>
		   	@elseif($Trailer_type==2)
		   	<li><b>Trailer type:</b>  Refrigerated </li>
		   	@elseif($Trailer_type==3)
		   	<li><b>Trailer type:</b>  Flatbed </li>
		   	@elseif($Trailer_type==4)
		   	<li><b>Trailer type:</b>  Specialized (RGN, Lowboy, Etc) </li>
		   	@elseif($Trailer_type==5)
		   	<li><b>Trailer type:</b>  Power Only </li>
		   	@else
		   	<li><b>Trailer type:</b>         </li>
             @endif
	...
	<div class="form">
		   ...
		   <ul>
		   	<li><b>Zipcode:</b>  {{$from_zip}} </li>
		   	<li><b>Date:</b>  {{$date}} </li>

           @if($from_location==1)
		   	<li><b>location:</b>  Residence </li>
		   	 @elseif($from_location==2)
		   	<li><b>location:</b> Business with a loading dock or forklift </li>

		   	 @elseif($from_location==3)
		   	<li><b>location:</b> Business without a loading dock or forklift </li>
		   	@else
		    <li><b>location:</b>         </li>
             @endif
		   </ul>
