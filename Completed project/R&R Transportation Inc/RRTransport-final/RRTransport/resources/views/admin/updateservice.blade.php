            ...
            <div class="detail">
              ...
              @if ($errors->any())
                ...
                <div class="form">
                 ...
                 <form  action="{{url('admin/storeupdateservice')}}/{{$id}}" enctype="multipart/form-data" method="POST" >
                         @csrf
                      <div class="part">
                        ...
                        <div class="part">
                            ...
                            <div class="col-md-12 data">
                                <input type="text" placeholder="Enter service Title" name="title" value="{{$title}}"required>
                            </div>   
                        </div> 
                         ...
                         <div class="part part1">
                            ...
                            <div class="col-md-12 data">
                                   <textarea placeholder="Enter text.."  name="long_desc" value="{{$long_desc}}" id="summernote">{!! $long_desc !!}</textarea>
                            </div>   
                        </div>
